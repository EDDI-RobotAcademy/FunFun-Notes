import 'package:first/naver_authentication/presentation/providers/naver_auth_providers.dart';
...
class NaverAuthModule {
  static List<SingleChildWidget> provideNaverProviders(String baseUrl) {
