...
def game_price_adjustment(game_title):
    ...
    if "Popular" in game_title:
        price_factor = random.uniform(2.0, 3.0)  # 가격 범위 확대
        quantity_factor = random.randint(50, 100)  # 수량 범위 확대
    else:
        price_factor = random.uniform(0.5, 1.0)  # 가격 범위 축소
        quantity_factor = random.randint(5, 15)  # 수량 범위 축소
...
# 엑셀로 내보내기
output_file = "orders_items_with_age4.xlsx"
