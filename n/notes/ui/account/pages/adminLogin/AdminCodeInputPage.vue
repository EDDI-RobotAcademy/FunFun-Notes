        ...
        <v-col cols="auto" style="padding-bottom: 90px">
          <v-card width="460">
            <v-card-text class="text-center px-12 py-16">
              ...
              <v-btn block x-large rounded color="primary" class="mt-4" @click="verifyAdminCode">
                확인
              </v-btn>

              <v-btn block x-large rounded color="gray lighten-1" class="mt-4" @click="cancel">
                취소
              </v-btn>
...
const verifyAdminCode = async () => {
  const isValid = await githubAuthentication.requestAdminCodeToDjango(adminCode.value);
